...
audio_page = int(os.environ["KMVAR_Page"])

if audio_page == 1:
	articles_path = Path("/Users/munirv3/Documents/Main Obsidian Vault/Home/015 Podcasts and Audio.md")
else:
	articles_path = Path("/Users/munirv3/Documents/Main Obsidian Vault/Home/020 Baha'i Audio.md")
